...
echo "[I] Shutting down and removing Bitbucket container."
...
echo "[I] Removing Bitbucket and PostgreSQL persistent data."
...
echo "[I] Restoring Bitbucket home directory."
if [ ! -d volumes/web ]; then
    mkdir -p volumes/web
fi
mv backups/tmp_restore/home volumes/web/data/

echo "[I] Creating and starting Bitbucket container."
